...
export type UploadFileIconProps = {
  color?: string;
  width?: string;
  height?: string;
};
...
const useController = ({
  ...
  width: width || "20px",
  height: height || "28px",
  color: color || colors.purple.primary.main,
  ...props,
});

const view = ({ color, width, height }: UploadFileIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 25 24"
...
/**
 * @name UploadFileIcon
 * @description Upload file svg icon
 * @author Skander Bouraoui <skander.bouraoui@quoprod.com>
 * @version 1.0.0
 */

const UploadFileIcon = (props: UploadFileIconProps) =>
